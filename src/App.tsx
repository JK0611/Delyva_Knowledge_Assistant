...
import { Send, Bot, User, Loader2, Sparkles, ThumbsUp, ThumbsDown, ChevronUp, Square } from 'lucide-react';
...
export default function App() {
  ...
  const suggestions = [
    ...
    "Courier does not Show Up",
    "Ninjvan Cold Chain Points",
    "Deliver with COD",
    "View my invoices",
    "Packaging Guideline",
    "Insurance",
            ...
            >
              ...
              {isLoading ? (
                <button
                  ...
                  className="w-9 h-9 mb-0.5 rounded-full flex items-center justify-center bg-white border border-slate-200 text-slate-600 shadow-sm hover:bg-slate-50 transition-all shrink-0 group"
                >
                  <Square size={14} className="fill-slate-600 group-hover:fill-slate-700" />
                </button>
              ) : (
                <button
                  type="submit"
